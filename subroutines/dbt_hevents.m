function [d,h,t] = dbt_hevents(dt,f0,tmax,h,tau,v,amp,snr,L,seed);
%DBT_HEVENTS: A program to generate data containing hyperbolas.
%
%  [d] = dbt_hevents(dt,f0,tmax,h,tau,v,amp,snr,L);
%
...
%
%    [d,h,t] = dbt_hevents; imagesc(h,t,d);
%
%
...
%
 ...
 if nargin == 0
  ...
  L = 9;
  seed=2013;
%   hevents(dt,f0,tmax,h,tau,v,amp,snr,L,seed);
 end;
